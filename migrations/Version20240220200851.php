 ...
 */
final class Version20240220200851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE teste_2');
        $this->addSql('DROP TABLE teste_3');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teste_2 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, coluna_teste VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('CREATE TABLE teste_3 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, coluna_teste VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_858EB8D9CB944F1A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__Phone AS SELECT id, student_id, number FROM Phone');
        $this->addSql('DROP TABLE Phone');
